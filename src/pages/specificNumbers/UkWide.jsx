    ...
    <div className="main-page">
      <section className="main-page__hero">
        <div className="main-page__hero-content">
          <h1>03 UK Wide Numbers</h1>
          <p className="text-[25px]">National Telephone Numbers</p>
          <p className="pl-[20px] border-solid border-l-[3px] my-7 text-lg">
            0333 numbers are UK wide national numbers which are not associated
            with a specific geographic location. This makes them ideal for
            businesses that want to appeal to customers from throughout the UK,
            instead of just their local area.
          </p>
          <p className="text-lg">
            The cost of calling 0333 numbers is the same as calling a landline
            number, be it from a landline or a mobile. Callers with free call
            minutes to landlines would also usually have calls to 0333 numbers
            included in their bundles. This means that callers can call you for
            free, even from their mobile.
          </p>
          <p className="text-lg">
            Using 0333 numbers for your inbound calls gives your business a
            presence across the whole UK. Plus with our FREE Control Panel &
            app, you’re in control 24/7.
          </p>
          <p className="text-lg">
      ...
      <div className="flex justify-center flex-col bg-slate-50">
        ...
        >
          <h2 className="text-2xl text-[#e50471]">Enter Destination for {currentNumber}</h2>
          <input
            type="text"
            value={destination}
