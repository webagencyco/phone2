...
const Charity = () => {
  ...
  const fetchPartialNumbers = async () => {
    try {
      const response = await axios.get(`${server}/api/numbers/partial/0333`);
    ...
    <div className="main-page">
      <section className="main-page__hero">
        <div className="main-page__hero-content">
          <h1>0300 Numbers</h1>
          <p className="text-[25px]">National Telephone Numbers</p>
          <p className="text-lg">
            0300 numbers are UK wide national numbers specifically for use by
            public sector bodies and not-for-profit bodies such as registered
            charities. All other types of business, such as sole traders,
            partnerships and limited companies should view our 0333 numbers.
          </p>
          <p className="text-lg">
            0300 numbers were introduced by Ofcom as an alternative number for
            organisations, who wish to offer their consumers a single, trusted
            point of contact.
          </p>
          <p className="text-lg">
            The cost of calling 0300 numbers is the same as calling a standard
            landline number, be it from a landline or mobile. Callers that have
            free inclusive call minutes to landlines would also usually have
            calls to 0300 numbers included in their bundles, potentially meaning
            that callers can call you for free, even from their mobile.
          </p>
          <p className="text-lg">
            Using an 0300 number for your inbound calls gives you the
            flexibility to control instantly online how and when you receive
            your calls whilst giving your callers a cost effective way of
            calling you.
          </p>
          <a href="#chooseNumber">
