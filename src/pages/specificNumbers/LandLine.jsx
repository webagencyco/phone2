    ...
    <div className="main-page">
      <section className="main-page__hero">
        <div className="main-page__hero-content">
          <h1>Mobile Landlines: Stay Connected On The Go</h1>
          <p className="text-[25px]">
            Mobile Landlines give you a local number for your mobile phone,
            allowing you to stay connected on the go while maintaining the
            professionalism of a traditional landline.
          </p>
          <p className="pl-[20px] border-solid border-l-[3px] my-7 text-lg">
            Our Mobile Landlines service is your key to breaking free from
            traditional constraints, enabling your business to communicate
            seamlessly anytime, anywhere. We’re giving away over 10 Free
            Features that help you tailor your phone to suit your business.
            Features like Branded Voicemail, Timed Diverts, Welcome
            Announcements and many more. Mobile Landlines are a game changer for
      ...
      <section id="chooseNumber" className="main-page__numbers">
        ...
        <div className="main-page__numbers-options flex justify-around">
          <div className="main-page__number-option w-[40%] !h-[400px] xs:w-[700%]">
            ...
            /> */}
            <h3>Receive Calls</h3>
            <p className="text-lg">Our Classic Virtual Numbers</p>
          ...
          <div className="main-page__number-option !h-[440px] w-[40%]">
            {/* <img
            ...
            <ul className="dropdownList px-10">
              ...
              <li className="w-[100%] dropdownItem">
                ...
                <div className="itemContent">
                  <p className="itemDescription">
                    Fully Dedicated VoIP App to Make <br /> Outbound Calls From
                    Your Number
                  </p>
                </div>
              </li>
              <li className="w-[100%] dropdownItem">
                <span className="dot w-[35px]"></span>
                <div className="itemContent">
                  <p className="itemDescription">
                    Transfer Calls, On Hold Music, Conference Calling - All
                    Included Free{" "}
                  </p>
                </div>
              </li>
